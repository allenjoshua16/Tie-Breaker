    ...
    <div className="space-y-12 pb-24">
      ...
      <section className="bg-white border border-border-light rounded-[2.5rem] p-10 shadow-sm">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-12">
          ...
          <div className="flex items-center gap-2 px-4 py-2 bg-gray-50 rounded-full border border-gray-100 shadow-inner">
             <span className="w-1.5 h-1.5 bg-brand-sage rounded-full animate-pulse" />
             <span className="text-[9px] font-bold uppercase tracking-widest text-gray-500">Live 2026 Index Link Active</span>
          </div>
        </div>
